...
def Attention(L, key_addr, val_addr, itr, valid_channel = n_channel, page_wise=False):
...
def main():
  ...
  if args.page_wise:
    ...
    # print_page_statistics(L, total_pages, active_pages, args.verbose)
  ...
  for key, value in args_dict.items():
      print(f"     {key}: {value}")
  print("---------------------------------------------------")
  run_attention(dhead, n_head_per_hbm, L, args.output, args.page_wise)
